...
#roads_med[zoom=10] {
  ::casing {
    ...
    [type='tertiary'] { line-color: @standard_case; }
...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=11] {
    ...
    [type='secondary'],
  	[type='secondary_link'] { line-width: @rdz11_med + 0.8; }
  ...
  [zoom=16] {
    [stylegroup='motorway'] { line-width: @rdz16_maj + 2.5; line-color: #555555; line-opacity: 0.5;}
    [stylegroup='mainroad'] { line-width: @rdz16_med + 2.5; line-color: #555555; line-opacity: 0.5;}
    //@rdz16_min + 2
    [stylegroup='minorroad']{ line-width: @rdz16_min; line-color: #555555; line-opacity: 0.5;}
    [stylegroup='service']  { 
      line-width: @rdz16_min / 3 + 2;
      line-color: #555555; 
    }
    //@rdz16_min / 4 + 2
    [stylegroup='noauto']   { line-dasharray: 3,3; line-width: 0; line-color: #aaa; line-opacity: 0.5;}
    [stylegroup='railway']  { line-width: 2 + 2;}
  }
  [zoom>=17] {
    [stylegroup='motorway'] { line-width: @rdz17_maj + 3; line-color: #555555; line-opacity: 0.3;}
    [stylegroup='mainroad'] { line-width: @rdz17_med + 2.5; line-color: #555555; line-opacity: 0.3;}
    [stylegroup='minorroad']{ line-width: @rdz17_min + 2; line-color: #555555; line-opacity: 0.3;}
    [stylegroup='service']  { 
    ...
    // @rdz17_min / 4 + 4
    [stylegroup='noauto']   { line-dasharray: 3,3; line-width: 0; line-color: #aaa; line-opacity: 0.3;}
    [stylegroup='railway']  { line-width: 3 + 4; } // 3 + 4
  }
  [zoom>=18] {
    [stylegroup='motorway'] { line-width: @rdz18_maj + 4; line-color: #555555; line-opacity: 0.3;}
    [stylegroup='mainroad'] { line-width: @rdz18_med + 4; line-color: #555555; line-opacity: 0.3;}
    [stylegroup='minorroad']{ line-width: @rdz18_min + 3.5; line-color: #555555; line-opacity: 0.3;}
    [stylegroup='service']  { 
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  /* -- widths -- */
  [zoom=11] {
    [stylegroup='motorway'] { line-width: @rdz11_maj; line-color: @motorway_fill; line-opacity: 0.8;}
    [stylegroup='mainroad'] { line-width: @rdz11_med; line-opacity: 0.8;}
    [stylegroup='minorroad']{ 
      line-width: 0;
      line-color: @secondary_fill;
      line-opacity: 0.8;
  ...
  [zoom=12] {
    [stylegroup='motorway'] { line-width: @rdz12_maj; line-color: @motorway_fill; line-opacity: 0.6;}
    [stylegroup='mainroad'] { line-width: @rdz12_med; line-color: @primary_fill; line-opacity: 0.6;}
    [stylegroup='minorroad']{ line-width: 0; }
    [stylegroup='railway']  { line-width: 0.4; }
  }
  [zoom=13] {
    [stylegroup='motorway'] { line-width: @rdz13_maj; line-color: @motorway_fill; line-opacity: 0.5;}
    [stylegroup='mainroad'] { line-width: @rdz13_med; line-color: @primary_fill; line-opacity: 0.5;}
    [stylegroup='minorroad']{ 
      line-width:0; // @rdz13_min;
      line-color: @secondary_fill;
    }
  ...
  [zoom=14] {
    [stylegroup='motorway'] { line-width: @rdz14_maj; line-color: @motorway_fill; line-opacity: 0.5;}
    [stylegroup='mainroad'] { line-width: @rdz14_med; line-color: @primary_fill; line-opacity: 0.5;}
    [stylegroup='minorroad']{ line-width: 0; line-color: @secondary_fill; line-opacity: 0.5;}
    [stylegroup='service']  { line-width: 0;  line-color: @secondary_fill; line-dasharray: 10, 3, 2, 3; line-opacity: 0.5;}
    [stylegroup='noauto']   { line-width: @rdz14_min / 4; line-dasharray: 1,1; }
    [stylegroup='railway']  { line-width: 1; }
  }
  [zoom=15] {
    [stylegroup='motorway'] { line-width: @rdz15_maj; line-color: @motorway_fill; line-opacity: 0.5;}
    [stylegroup='mainroad'] { line-width: @rdz15_med; line-color: @primary_fill; line-opacity: 0.5;}
    [stylegroup='minorroad']{ line-width: @rdz15_min; line-color: @secondary_fill; line-opacity: 0.5;}
    [stylegroup='service']  { 
    ...
    [stylegroup='noauto']   { line-width: @rdz15_min / 4 + 1; line-dasharray: 2,2; line-color:@standard_fill; line-opacity: 0.5;}
    [stylegroup='railway']  { line-width: 1.5; }
  }
  [zoom=16] {
    [stylegroup='motorway'] { line-width: @rdz16_maj; line-color: @motorway_fill; line-opacity: 0.5;}
    [stylegroup='mainroad'] { line-width: @rdz16_med; line-color: @primary_fill; line-opacity: 0.5;}
    [stylegroup='minorroad']{ line-width: @rdz16_min; line-color: @secondary_fill; line-opacity: 0.5;}
    [stylegroup='service']  { 
    ...
    [stylegroup='noauto']   { line-width: @rdz16_min / 4 + 1; line-dasharray: 2,2; line-opacity: 0.5;}
    [stylegroup='railway']  { line-width: 2; }
  }
  [zoom=17] {
    [stylegroup='motorway'] { line-width: @rdz17_maj; line-color: @motorway_fill; line-opacity: 0.3;}
    [stylegroup='mainroad'] { line-width: @rdz17_med; line-color: @primary_fill; line-opacity: 0.3;}
    [stylegroup='minorroad']{ 
  ...
  [zoom>=18] {
    [stylegroup='motorway'] { line-width: @rdz18_maj; line-color: @motorway_fill; line-opacity: 0.3;}
    [stylegroup='mainroad'] { line-width: @rdz18_med; line-color: @primary_fill; line-opacity: 0.3;}
    [stylegroup='minorroad']{ line-width: @rdz18_min; line-color: @secondary_fill; line-opacity: 0.3;}
    [stylegroup='service']  { 
    ...
    [stylegroup='noauto']   { line-width: @rdz18_min / 4; line-dasharray: 3,3; line-opacity: 0.3;}
